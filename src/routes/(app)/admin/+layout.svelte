		...
		<nav class="   px-2.5 pt-1 backdrop-blur-xl drag-region">
			<div class=" flex items-center gap-1">
				...
				<div class=" flex w-full">
					...
					<a
						class="min-w-fit rounded-full p-1.5 {$page.url.pathname.includes('/admin/qa-records')
							? ''
							: 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition"
						href="/admin/qa-records">问答记录</a
					>
					...
					<a
						class="min-w-fit rounded-full p-1.5 {$page.url.pathname.includes('/admin/oauth')
							? ''
							: 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition"
						href="/admin/oauth">OAuth客户端</a
					>
					</div>
				</div>
			</div>
